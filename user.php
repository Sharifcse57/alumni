  ...
  <div class="section">
    <div class="container">
         <form action="search.php" method="post">
            ...
            <button class="waves-effect waves-light btn green darken-4" type="submit" name="submit" >search</button>
          </form><br>
        ...
        {  
          ?>
              ...
              Status :<?php 
                ...
                ?><br>
                <b>professional Details:</b>    <?php echo $row['professional_info'];   ?><br>
               <hr> <!-- <b>Contact Number :<?php echo $row['contact'] ?></b><hr> -->
