...
<body id="login">
	...
	<h2 class="form-heading">Alumni Registration</h2>
	<form class="form-signin app-cam"onsubmit="return validateForm(this);" action="registrationdb.php" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
					Professional Details :
					 <textarea class="form-control1" rows="5" id="comment" name="prd"></textarea>
						<!-- <div class="col-sm-12"><textarea name="prd" id="txtarea1" cols="50" rows="4" class="form-control1"></textarea></div> -->
		</div>
