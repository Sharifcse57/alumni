...
// output data of each row
      if($row = mysqli_fetch_assoc($result)) { 
        ...
        <div class="section">
          <div class="container">
            <form class="col s12" action="myprofileeditdb.php" method="post">
              <div class=" col s12">
              ...
              <div class=" col s12">
               ...
               <div class=" col s12">
                <label for="email">professional_info</label>
                <input type="text" class="validate" value="<?php echo $row['professional_info']; ?>" name="prd">
